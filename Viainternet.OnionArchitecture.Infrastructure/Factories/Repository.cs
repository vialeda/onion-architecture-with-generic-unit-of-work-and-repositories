...
using Viainternet.OnionArchitecture.Infrastructure.FakeStuff;

namespace Viainternet.OnionArchitecture.Infrastructure.Factories
{
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : class, IObjectState
    {
            ...
            int? pageSize = null)
        {
            ...
            if (filter != null)
            {
                // Remove of AsExpandable LinqKit librairie.
